...
--Revenue in FY21
-- Total Revenue
select SUM(Revenue) as Total_Revenue from dbo.['Revenue Raw Data$']
where Month_ID in
( 
...
select Month_ID, SUM(Revenue) as Total_Revenue from dbo.['Revenue Raw Data$']
where Month_ID in
( 
select Distinct Month_ID from dbo.ipi_Calendar_lookup$
where [Fiscal Year]= 'FY21'
...
select SUM(Revenue) as Total_Revenue21 from dbo.['Revenue Raw Data$']
where Month_ID in
( 
select Distinct Month_ID from dbo.ipi_Calendar_lookup$
where [Fiscal Year]= 'FY21'
...
select Month_ID, SUM(Revenue) as Total_Revenue20 from dbo.['Revenue Raw Data$']
where Month_ID in
( 
select Distinct Month_ID from dbo.ipi_Calendar_lookup$
...
select Distinct Month_ID - 12 from dbo.['Revenue Raw Data$'] 
where Month_ID in
(
select Distinct Month_ID from dbo.ipi_Calendar_lookup$
where [Fiscal Year]= 'FY21'
...
select SUM(Revenue) as Total_Revenue20 from dbo.['Revenue Raw Data$']
where Month_ID in
( 
	select Distinct Month_ID - 12 from dbo.['Revenue Raw Data$'] 
	where Month_ID in
...
select Month_ID, SUM(Revenue) as Total_Revenue21 from dbo.['Revenue Raw Data$']
where Month_ID in
	( 
	138
	)
...
select SUM(Revenue) as Latest_Month_Revenue21 from dbo.['Revenue Raw Data$']
where Month_ID in
	( 
...
(
select  SUM(Revenue) as Previous_Month_Revenue21 from dbo.['Revenue Raw Data$']
where Month_ID in
	( 
	Select MAX(Month_ID)-1 from dbo.['Revenue Raw Data$']
	)
) as b
...
-- To find Target
select Month_ID, sum(Target) as Target from dbo.['Targets Raw Data$']
where Month_ID in 
	(
	select Distinct Month_ID from dbo.ipi_Calendar_lookup$
	where [Fiscal Year]= 'FY21'
...
( 
	select Distinct Month_ID from dbo.['Revenue Raw Data$'] 
	where Month_ID in
		(
		select Distinct Month_ID from dbo.ipi_Calendar_lookup$
		where [Fiscal Year]= 'FY21'
...
(
	select sum(Target) as Target from dbo.['Targets Raw Data$']
	where Month_ID in 
		( 
		select Distinct Month_ID from dbo.['Revenue Raw Data$'] 
		where Month_ID in
